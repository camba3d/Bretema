...
inline static std::unordered_map<u32, std::string_view> const DebugType {
    { VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT, "General" },
    { VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT, "Validation" },
    { VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT, "Performance" },
    { VK_DEBUG_UTILS_MESSAGE_TYPE_FLAG_BITS_MAX_ENUM_EXT, "OtherType" },
};
inline static std::unordered_map<u32, std::string_view> const PresentMode {
...
inline static std::unordered_map<u32, std::string_view> const Format {
...
inline static std::unordered_map<u32, std::string_view> const Result {
